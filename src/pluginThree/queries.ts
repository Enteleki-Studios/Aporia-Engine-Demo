...
import { Animation, GltfComponent, PerspectiveCamera, RenderableDynamic } from './components'
...
export const perspectiveCameraQuery = createQuery([PerspectiveCamera, Transform3DComponent])
