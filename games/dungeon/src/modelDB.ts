...
const modelDB: Record<string, Model> = {
    ...
    shiba: {
        modelPath: `${MF}/characters/shiba/ShibaInu.fbx`,
        animations: {
            attack: 'AnimalArmature|Attack',
            runJump: 'AnimalArmature|Gallop_Jump',
            idleHitReactRight: 'AnimalArmature|Idle_HitReact_Right',
            idleHitReactLeft: 'AnimalArmature|Idle_HitReact_Left',
            run: 'AnimalArmature|Gallop',
            eat: 'AnimalArmature|Eating',
            // walk: "AnimalArmature|Walk",
            walk: 'AnimalArmature|Gallop',
            idle: 'AnimalArmature|Idle',
            idle2: 'AnimalArmature|Idle_2',
            idle3: 'AnimalArmature|Idle_2_HeadLow',
            jumpToIdle: 'AnimalArmature|Jump_ToIdle',
